...
After completing windows setup then run windows command line (cmd)
  cd daemon
  copperbarsd
You would need to create a configuration file copperbars.conf in the default
wallet directory. Grant access to copperbarsd.exe in anti-virus and firewall
...
copperbarsd backupwallet <destination_backup_file>
Then shutdown ppcoind by
copperbarsd stop
Start up the new copperbarsd (0.3.0).
